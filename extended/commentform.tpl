<div id="serendipityCommentFormC" class="serendipityCommentForm">
    ...
    <dl>
       ...
       <dd class="serendipity_commentsValue">
           <input type="text" id="serendipity_commentform_url" name="serendipity[url]" value="{$commentform_url}" size="40"/>
       </dd>
       <dt class="serendipity_commentsLabel">
...
{if $is_moderate_comments}
       <dt>&#160;</dt>
       <dd class="serendipity_commentsValue serendipity_msg_important">
